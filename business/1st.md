...
- [Πρώτο Παραδοτέο](#πρώτο-παραδοτέο)
    - [Σκοπός](#σκοπός)
    - [Λειτουργικές Απαιτήσεις](#λειτουργικές-απαιτήσεις)
        - [Παραδοχές](#παραδοχές)
        - [Πελατειακή πολιτική](#πελατειακή-πολιτική)
        - [Περιορισμοί](#περιορισμοί)
        - [Σενάρια - Περιπτώσεις Χρήσης](#σενάρια---περιπτώσεις-χρήσης)
            - [**ΑΝΩΝΥΜΟΣ ΧΡΗΣΤΗΣ**](#ανωνυμος-χρηστης)
            - [**ΓΟΝΕΑΣ**](#γονεας)
            - [**ΠΑΡΟΧΟΣ**](#παροχος)
            - [**ΔΙΑΧΕΙΡΙΣΤΗΣ**](#διαχειριστης)
        - [Σύνοψη Ρόλων Χρηστών (Διακιώματα και Ρόλοι)](#σύνοψη-ρόλων-χρηστών-διακιώματα-και-ρόλοι)
...
2. **Εγγραφή ως γονέας :**
    ...
    *Περιορισμοί:* Ο χρήστης να μην είναι ήδη εγγεγραμμένος στο σύστημα (το οποίο επαληθεύεται μέσω της διεύθυνσης ηλκτρονικού ταχυδρομείου του) και να είναι διαθέσιμο το username που επέλεξε.
