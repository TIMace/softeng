...
4. **Διαχείριση πορτοφολιού :**  
  ...
  - Φόρτωση πόντων  
    ...
    Παραδοχές:  
    Ορίζουμε για ευκολία την ισοτιμία πόντων - ευρώ να είναι ένα προς ένα. Ο χρήστης έτσι έχει ρεαλιστική εικόνα του χρηματικού ποσού
    που καταθέτει και ξοδεύει για κάθε δραστηριότητα, οπότε διαφορετική ισοτιμία κρίνεται περιττή.
