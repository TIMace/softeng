...
2. **Εγγραφή ως γονέας :**
  ...
  Ο χρήστης συμπληρώνει μια φόρμα εγγραφής όπου συμπληρώνει όλα τα απαραίτητα προσωπικά στοιχεία (όπως όνομα, επίθετο, διεύθυνση, τηλέφωνο επικοινωνίας, email) ώστε να δημιουργηθεί ο λογαριασμός και το προσωπικό του ηλεκτρονικό πορτοφόλι.
  ...
  Περιορισμοί:  
  Ο χρήστης να μην είναι ήδη εγγεγραμμένος στο σύστημα (το οποίο επαληθεύεται μέσω της διεύθυνσης ηλκτρονικού ταχυδρομείου του) και να είναι διαθέσιμο το username που επέλεξε.

3. **Εγγραφή ως πάροχος :**

    Ο χρήστης συμπληρώνει μια φόρμα εγγραφής όπου συμπληρώνει τα προσωπικά του στοιχεία (όπως στην περίπτωση του γονέα) ή/και τα στοιχεία της εταιρείας που αντιπροσωπεύει, καθώς επίσης και το ΑΦΜ, ώστε να δημιουργηθεί ο λογαριασμός του με το αντίστοιχο ηλεκτρονικό πορτοφόλι.
...
4. **Σύνδεση:**
    ...
    Η σύνδεση ολοκληρώνεται αν ο συνδυασμός username-password είναι έγκυρος και ο χρήστης είναι ενεργός, δηλαδή δεν έχει απενεργοποιηθεί από τον διαχειριστή.
...
1. **Επεξεργασία Προφίλ :**
  ...
  Ο γονέας μπορεί να αλλάξει κάποια προσωπικά στοιχεία, όπως διεύθυνση,τηλέφωνο επικοινωνίας και κωδικός .εισόουδ
...
4. **Διαχείριση πορτοφολιού :**
    ...
    Παραδοχές:  
    Ορίζουμε για ευκολία την ισοτιμία πόντων - ευρώ να είναι ένα προς ένα. Ο χρήστης έτσι έχει ρεαλιστική εικόνα του χρηματικού ποσού που καταθέτει και ξοδεύει για κάθε δραστηριότητα, οπότε διαφορετική ισοτιμία κρίνεται περιττή.
...
5.  **Αγορά εισιτηρίου :**  
  ...
  Προϋποθέσεις:  
  - Για να πραγματοπιηθεί η αγορά ενός συνόλου επιθυμητών δραστηριοτήτων, θα πρέπει ο χρήστης να διαθέτει επαρκές απόθεμα πόντων στο ηλεκτρονικό του πορτοφόλι.
...
5. **Διαχείριση πορτοφολιού :**
  ...
  Ο πάροχος μπορεί να προβάλει τους πόντους που έχει μαζέψει στο πορτοφόλι του (απο τους οποίους θα πληρωθεί), οι οποίοι όμως θα του εμφανίζονται ως το αντίστοιχο χρηματικό ποσό. Μπορεί επίσης να ζητήσει την πληρωμή του (μεταφορά απο τον λογαριασμό της πλατφόρμας στο λογαριασμό του παρόχου του ποσού που αντιστοιχεί στους πόντους του), όποτε εκείνος θελήσει.

  Περιοορισμοί:

  Στο ποσό που βλέπει ο πάροχος ως έσοδα θα προσμετρούνται τα έσοδα μόνο όσων δραστηριοτήτων η έναρξη έχει γίνει τουλάχιστον δύο(2) μήνες πριν(είτε αυτά έχουν ολοκληρωθεί, είτε όχι).
...
2. **Ανάθεση και ανάκληση ρόλων και δικαιωμάτων**  
    Ο διαχειριστής είναι υπεύθυνος για την ολοκλήρωση της εγγραφής και την ενεργοποίηση του λογαριασμού του γονέα (μέσω επιβεβαίωσης του email) και του παρόχου (μέσω επιβεβαίωσης του ΑΦΜ, ή με φυσική παρουσία).
