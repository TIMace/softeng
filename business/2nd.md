...
Όταν ο χρήστης εισέλθει στην υπηρεσία σαν γονέας, οι επιλογές στα δεξιά της μπάρας αλλάζουν ανάλογα. Για τον χρήστη, προστίθεται η δυνατότητα να μεταβεί στον λογασιασμό του, να δει το ποσό του πορτοφολιού του και να προσθέσει χρήματα σε αυτό.
