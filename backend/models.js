...
const Sequelize = require('sequelize')
    ...
    , User = sequelize.define('user', {
        ...
        user_credits : { type : Sequelize.INTEGER, validate : { min : 0 }, allowNull : false, defaultValue : 0 },
    ...
    , Provider = sequelize.define('provider' , {
        ...
        provider_email : { type : Sequelize.STRING, validate : { isEmail : true }, allowNull : false },
        ...
        provider_credits : { type : Sequelize.INTEGER, validate : { min : 0 }, allowNull : false, defaultValue : 0 },
    ...
    , Evnt = sequelize.define('event', {
        ...
        event_available_tickets : { type : Sequelize.INTEGER, validate : { min : 1 }, allowNull : false, default : 1 },
